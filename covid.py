...
if __name__ == '__main__':
    ...
    keras_model = Build_Model(model_name="2020_covid.h5",patience=15,directory1="D:/CNN_Projects/Emotions/train", 
                              directory2="D:/CNN_Projects/Emotions/test",size=48, color_mode="rgb", 
                              class_mode="categorical", batch=128)
    keras_model.model_fitting(filter_count=64,channel=3 , class_count=1 , activation='sigmoid',epochs=30,
                              loss_func='binary_crossentropy',steps=80)
